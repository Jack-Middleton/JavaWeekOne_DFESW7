...
public class JDBC_Setup {
	...
	public Pizzeria returnResults(ResultSet resultSet) {
		try {
			// Create a new variable
			// Equal to the set of results, and find the value with field "id" that is a
			// long
			...
			Pizzeria pizza = new Pizzeria(id, type, slices, stuffedCrust);
			return pizza;
		} catch (SQLException e) {
			e.printStackTrace();
		}
